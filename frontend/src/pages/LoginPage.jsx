...
function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(
                Array.isArray(detail) ? detail[0]?.msg : detail || "Invalid credentials. Please try again."
            )
        } finally {
            setLoading(false)
        }
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    className={[
                                        "w-full bg-white/5 border text-white placeholder-slate-500 pl-11 pr-4 py-3.5 rounded-2xl text-sm focus:outline-none focus:ring-2 transition",
                            ...
                            {fieldErrors.username && (
                                <p className="text-red-400 text-xs pl-1">{fieldErrors.username}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={[
                                        "w-full bg-white/5 border text-white placeholder-slate-500 pl-11 pr-12 py-3.5 rounded-2xl text-sm focus:outline-none focus:ring-2 transition",
